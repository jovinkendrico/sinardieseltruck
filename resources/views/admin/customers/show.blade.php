            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/customers' . '/' . $customer->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nama </th><td> {{ $customer->nama }} </td></tr><tr><th> Alamat </th><td> {{ $customer->alamat }} </td></tr><tr><th> Email </th><td> {{ $customer->email }} </td></tr><tr><th> Notelp </th><td> {{ $customer->notelp }} </td></tr>
                                </tbody>
                            </table>
                        </div>
