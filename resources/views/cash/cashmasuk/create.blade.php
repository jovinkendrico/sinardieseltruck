            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Create New Cash Msauk</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" id="form" action="{{route('cashmasuk.store')}}" onsubmit="return prepareAndSubmitForm()" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                <th>Total Jumlah :</th>
                                                <td><input type="text" class="form-control" id="totalJumlah" name="totalJumlah" value="Rp 0.00" readonly></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
