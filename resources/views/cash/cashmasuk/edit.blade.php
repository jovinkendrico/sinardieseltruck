                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('cashmasuk.update',$cashmasuk->id)}}" onsubmit="return prepareAndSubmitForm()" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="id_invoice" value="{{$cashmasuk->id_bukti}}" name="id_invoice" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="akun_masuk">Akun Kas:</label>
                                        <select class="form-control select2bs4" id="akun_masuk" name="akun_masuk" style="width: 100%;">
                                            ...
                                            <option data-merk={{$subakun->id}} value="{{$subakun->id}}" {{ $subakun->id == $cashmasuk->id_akunmasuk ? 'selected' : ''}}>{{$subakun->nomor_akun}} - {{$subakun->nama}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="akun_keluar">Diterima Dari:</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="table" id="itemTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="display: none;">{{$detailcashmasuk->id_akunkeluar}}</td>
                                                <td>{{$detailcashmasuk['akunkeluar']['nomor_akun']}} - {{$detailcashmasuk['akunkeluar']['nama']}}</td>
                                ...
                                <div class="col-md-4">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                <th>Total Jumlah :</th>
                                                <td><input type="text" class="form-control" id="totalJumlah" name="totalJumlah" value="Rp {{$cashmasuk->total}}.00" readonly></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
<script>
    ...
    function addRow() {
            ...
            var akun_keluar = document.getElementById("akun_keluar");
            ...
            document.getElementById("akun_masuk").readOnly = true;

            // Set the cell values
            cell1.innerHTML = akun_keluar.options[akun_keluar.selectedIndex].value;
            cell1.style.display = 'none'
            cell2.innerHTML = akun_keluar.options[akun_keluar.selectedIndex].text;
