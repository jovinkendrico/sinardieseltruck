            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Pengecekan Mobil</h3>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{route('pengecekan.update',$pengecekan->id)}}" onsubmit="return prepareAndSubmitForm()" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$pengecekan->pemeriksa}}" id="pemeriksa" name="pemeriksa">
                                    </div>
                                    <div class="form-group">
                                        <label for="service">Service:</label>
                                        <input type="text" class="form-control" value="{{$pengecekan->service}}" id="service" name="service">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" id="id_tr" name="id_tr" style="width: 100%;" onchange="updateMerk()">
                                            ...
                                            <option data-merk={{$truk->jenis}} value="{{$truk->id}}" {{ $truk->id == $pengecekan->id_truk ? 'selected' : ''}}>{{$truk->plat}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="jatuh_tempo">Merk Mobil:</label>
                                        <input type="text" class="form-control" value="{{$pengecekan['truk']['jenis']}}" id="merk" name="merk" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <table class="table" id="itemTable">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($detailPengecekans as $detailPengecekan)
                                                <tr>
                                                    <td style="display: none;">{{$detailPengecekan['perlengkapan']['id']}}</td>
